...
DEPENDS = "camera-info-manager catkin diagnostic-updater dynamic-reconfigure image-geometry image-transport message-filters polled-camera roscpp sensor-msgs std-msgs"
