...
DEPENDS = "angles python-empy-native cmake-modules costmap-2d dynamic-reconfigure eigen geometry-msgs message-generation nav-core nav-msgs pcl-conversions pcl-ros pluginlib rosconsole roscpp rospy std-msgs tf visualization-msgs voxel-grid"
