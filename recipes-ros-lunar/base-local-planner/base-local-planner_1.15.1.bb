...
DEPENDS = "angles catkin cmake-modules costmap-2d dynamic-reconfigure eigen geometry-msgs libpcl-all-dev message-generation message-runtime nav-core nav-msgs pcl-conversions pcl-ros pluginlib rosconsole roscpp rospy std-msgs tf visualization-msgs voxel-grid"
