...
SRC_URI = "https://github.com/ros-gbp/bond_core-release/archive/release/lunar/bondcpp/1.8.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/bond_core-release-release-lunar-bondcpp-1.8.1-0"
