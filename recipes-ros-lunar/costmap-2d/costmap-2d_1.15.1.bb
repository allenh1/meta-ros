...
DEPENDS = "catkin-native catkin cmake-modules dynamic-reconfigure geometry-msgs laser-geometry libpcl-all-dev map-msgs message-filters message-generation message-runtime nav-msgs pcl-conversions pcl-ros pluginlib rosconsole roscpp rostest sensor-msgs std-msgs tf visualization-msgs voxel-grid"
