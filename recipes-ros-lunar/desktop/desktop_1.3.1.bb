...
DEPENDS = "python-empy-native common-tutorials geometry-tutorials robot ros-tutorials roslint visualization-tutorials viz"
...
S = "${WORKDIR}/metapackages-release-release-lunar-desktop-1.3.1-0"
