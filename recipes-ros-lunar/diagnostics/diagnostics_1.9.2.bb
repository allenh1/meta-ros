...
DEPENDS = "python-empy-native diagnostic-aggregator diagnostic-analysis diagnostic-common-diagnostics diagnostic-updater self-test"
...
S = "${WORKDIR}/diagnostics-release-release-lunar-diagnostics-1.9.2-0"
