...
DEPENDS = "angles python-empy-native control-toolbox controller-manager gazebo-dev gazebo-ros hardware-interface joint-limits-interface pluginlib roscpp std-msgs transmission-interface urdf"
