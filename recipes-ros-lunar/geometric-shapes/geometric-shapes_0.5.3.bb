...
DEPENDS = "assimp assimp-dev boost catkin-native catkin eigen eigen-stl-containers console-bridge libqhull octomap pkgconfig random-numbers resource-retriever shape-msgs visualization-msgs"
