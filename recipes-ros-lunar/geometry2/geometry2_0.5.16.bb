...
DEPENDS = "python-empy-native tf2 tf2-bullet tf2-eigen tf2-geometry-msgs tf2-kdl tf2-msgs tf2-py tf2-ros tf2-sensor-msgs tf2-tools"
...
S = "${WORKDIR}/geometry2-release-release-lunar-geometry2-0.5.16-0"
