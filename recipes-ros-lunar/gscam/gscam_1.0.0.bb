...
DEPENDS = "camera-calibration-parsers camera-info-manager catkin-native cv-bridge image-transport libgstreamer-plugins-base1.0-dev libgstreamer1.0-dev nodelet roscpp sensor-msgs"
