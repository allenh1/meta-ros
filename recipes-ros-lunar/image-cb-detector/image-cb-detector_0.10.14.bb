...
DEPENDS = "actionlib actionlib-msgs calibration-msgs python-empy-native cv-bridge geometry-msgs image-transport message-filters message-generation message-runtime roscpp sensor-msgs std-msgs"
