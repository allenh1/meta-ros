...
DEPENDS = "actionlib angles python-empy-native cmake-modules control-msgs control-toolbox controller-interface hardware-interface realtime-tools roscpp trajectory-msgs urdf"
