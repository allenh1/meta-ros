...
DEPENDS = "actionlib armadillo python-empy-native control-msgs geometry-msgs katana-msgs kni moveit-msgs roscpp roslib sensor-msgs std-srvs tf trajectory-msgs urdf"
