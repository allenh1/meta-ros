...
SECTION = "devel"
LICENSE = "GPL"
LIC_FILES_CHKSUM = "file://package.xml;beginline=14;endline=14;md5=fe6a07ee75db997e0a74d91b3b60fb3a"
...
S = "${WORKDIR}/katana_driver-release-release-lunar-kni-1.1.2-0"
