...
SRC_URI = "https://github.com/mavlink/mavros-release/archive/release/lunar/${PN}/0.21.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/mavros-release-release-lunar-${PN}-0.21.5-0"
