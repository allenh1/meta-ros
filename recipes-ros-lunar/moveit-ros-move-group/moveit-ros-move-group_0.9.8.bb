...
DEPENDS = "actionlib python-empy-native moveit-core moveit-kinematics moveit-ros-planning pluginlib std-srvs tf"
...
S = "${WORKDIR}/moveit-release-release-lunar-moveit_ros_move_group-0.9.8-0"
