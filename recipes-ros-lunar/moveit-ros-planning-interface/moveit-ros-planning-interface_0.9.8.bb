...
DEPENDS = "actionlib python-empy-native eigen eigen-conversions moveit-ros-manipulation moveit-ros-move-group moveit-ros-planning moveit-ros-warehouse python python-catkin-pkg-native rosconsole roscpp rospy tf tf-conversions"
