...
DEPENDS = "python-empy-native moveit-core moveit-planners moveit-plugins moveit-ros-manipulation moveit-ros-move-group moveit-ros-perception moveit-ros-planning moveit-ros-planning-interface moveit-ros-warehouse"
...
S = "${WORKDIR}/moveit-release-release-lunar-moveit_runtime-0.9.8-0"
