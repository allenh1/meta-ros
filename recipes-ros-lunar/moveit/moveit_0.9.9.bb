...
SRC_URI = "https://github.com/ros-gbp/moveit-release/archive/release/lunar/moveit/0.9.9-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/moveit-release-release-lunar-moveit-0.9.9-0"
