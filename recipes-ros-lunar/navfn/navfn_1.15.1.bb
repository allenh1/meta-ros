...
DEPENDS = "catkin-native catkin cmake-modules costmap-2d geometry-msgs libpcl-all-dev message-generation message-runtime nav-core nav-msgs netpbm pcl-conversions pcl-ros pluginlib rosconsole roscpp tf visualization-msgs"
