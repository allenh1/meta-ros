...
SRC_URI = "https://github.com/ros-gbp/navigation-release/archive/release/lunar/navigation/1.15.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/navigation-release-release-lunar-navigation-1.15.1-0"
