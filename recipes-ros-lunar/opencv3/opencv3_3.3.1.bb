...
SRC_URI = "https://github.com/ros-gbp/opencv3-release/archive/release/lunar/opencv3/3.3.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/opencv3-release-release-lunar-opencv3-3.3.1-0"
