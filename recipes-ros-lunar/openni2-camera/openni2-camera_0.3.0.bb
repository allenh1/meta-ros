...
DEPENDS = "camera-info-manager catkin-native catkin dynamic-reconfigure image-transport libopenni2-dev message-generation message-runtime nodelet roscpp sensor-msgs"
