...
DEPENDS = "python-empy-native cmake-modules dynamic-reconfigure eigen genmsg libpcl-all-dev libvtk-java message-filters nodelet nodelet-topic-tools pcl-conversions pcl-msgs pluginlib proj qtbase5-dev rosbag rosconsole roscpp roslib sensor-msgs std-msgs tf tf2-eigen"
