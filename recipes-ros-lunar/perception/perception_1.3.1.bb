...
DEPENDS = "python-empy-native image-common image-pipeline image-transport-plugins laser-pipeline perception-pcl ros-base vision-opencv"
...
S = "${WORKDIR}/metapackages-release-release-lunar-perception-1.3.1-0"
