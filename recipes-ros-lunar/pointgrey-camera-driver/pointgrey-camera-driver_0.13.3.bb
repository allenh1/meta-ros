...
DEPENDS = "camera-info-manager catkin curl diagnostic-updater dpkg dynamic-reconfigure image-exposure-msgs image-proc image-transport libraw1394-dev libusb-1.0-dev nodelet roscpp sensor-msgs stereo-image-proc wfov-camera-msgs"
