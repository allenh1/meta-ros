...
DEPENDS = "bluez catkin diagnostic-msgs joystick libusb-dev python-bluez rosgraph rospy sensor-msgs"
SRC_URI = "https://github.com/ros-gbp/joystick_drivers-release/archive/release/lunar/ps3joy/1.11.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/joystick_drivers-release-release-lunar-ps3joy-1.11.0-0"
