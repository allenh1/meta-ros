...
DEPENDS = "catkin-native catkin cmake-modules diagnostic-msgs diagnostic-updater eigen eigen-conversions geographic-msgs geometry-msgs message-filters message-generation message-runtime nav-msgs nodelet python-catkin-pkg-native roscpp roslint sensor-msgs std-msgs std-srvs tf2 tf2-geometry-msgs tf2-ros xmlrpcpp yaml-cpp"
