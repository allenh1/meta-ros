...
DEPENDS = "python-empy-native control-msgs diagnostics executive-smach filters geometry robot-model robot-state-publisher ros-base xacro"
...
S = "${WORKDIR}/metapackages-release-release-lunar-robot-1.3.1-0"
