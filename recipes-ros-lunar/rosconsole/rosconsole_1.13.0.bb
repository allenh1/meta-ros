...
DEPENDS = "apr boost python-empy-native cpp-common log4cxx rosbuild rostime rosunit catkin-native"
...
S = "${WORKDIR}/ros_comm-release-release-lunar-rosconsole-1.13.0-0"
