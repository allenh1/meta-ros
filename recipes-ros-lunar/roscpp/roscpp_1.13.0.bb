...
DEPENDS = "catkin cpp-common message-generation message-runtime pkg-config rosconsole roscpp-serialization roscpp-traits rosgraph-msgs roslang rostime std-msgs xmlrpcpp"
