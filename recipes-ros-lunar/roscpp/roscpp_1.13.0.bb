...
DESCRIPTION = "roscpp is a C++ implementation of ROS. It provides
    a  that enables C++ progr"
AUTHOR = "OSRF"
SECTION = "devel"
LICENSE = "BSD"
LIC_FILES_CHKSUM = "file://package.xml;beginline=1;endline=1;md5=04924f319f9717fda8b9fdc8fbfcdce4"

DEPENDS = "catkin cpp_common message_generation message_runtime pkg-config rosconsole roscpp_serialization roscpp_traits rosgraph_msgs roslang rostime std_msgs xmlrpcpp"
