...
DEPENDS = "catkin-native catkin cpp-common message-generation message-runtime pkgconfig rosconsole roscpp-serialization roscpp-traits rosgraph-msgs roslang rostime std-msgs xmlrpcpp"
