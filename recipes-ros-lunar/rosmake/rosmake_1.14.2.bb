...
SRC_URI = "https://github.com/ros-gbp/ros-release/archive/release/lunar/rosmake/1.14.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/ros-release-release-lunar-rosmake-1.14.2-0"
