...
SRC_URI = "https://github.com/ros-gbp/ros_comm-release/archive/release/lunar/rosmsg/1.13.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/ros_comm-release-release-lunar-rosmsg-1.13.5-0"
