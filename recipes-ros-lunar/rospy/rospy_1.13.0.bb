...
DEPENDS = "python-empy-native genpy python-numpy python-rospkg python-pyyaml roscpp rosgraph rosgraph-msgs roslib std-msgs"
...
S = "${WORKDIR}/ros_comm-release-release-lunar-rospy-1.13.0-0"
