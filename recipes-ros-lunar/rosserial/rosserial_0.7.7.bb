...
SRC_URI = "https://github.com/ros-gbp/rosserial-release/archive/release/lunar/rosserial/0.7.7-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/rosserial-release-release-lunar-rosserial-0.7.7-0"
