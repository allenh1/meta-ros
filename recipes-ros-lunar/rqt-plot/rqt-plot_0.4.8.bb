...
DEPENDS = "python-empy-native python-matplotlib python-numpy python-rospkg python-qt-binding qt-gui-py-common qwt-dependency rosgraph rostopic rqt-gui rqt-gui-py rqt-py-common std-msgs"
