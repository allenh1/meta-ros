...
DEPENDS = "catkin-native catkin geometry-msgs gl-dependency python-opengl python-rospkg python-qt-binding rospy rostopic rqt-gui rqt-gui-py rqt-py-common tf"
