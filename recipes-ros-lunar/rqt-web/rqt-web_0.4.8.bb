...
DEPENDS = "catkin-native catkin python-rospkg python-qt-binding qt-gui rospy rqt-gui rqt-gui-py webkit-dependency"
...
S = "${WORKDIR}/rqt_web-release-release-lunar-rqt_web-0.4.8-0"
