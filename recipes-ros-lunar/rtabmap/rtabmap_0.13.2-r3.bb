...
SRC_URI = "https://github.com/introlab/rtabmap-release/archive/release/lunar/rtabmap/0.13.2-3.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/rtabmap-release-release-lunar-rtabmap-0.13.2-3"
