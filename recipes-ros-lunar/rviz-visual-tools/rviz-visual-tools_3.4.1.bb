...
DEPENDS = "catkin-native catkin eigen-conversions eigen-stl-containers geometry-msgs graph-msgs libqt5x11extras5-dev roscpp roslint rviz sensor-msgs std-msgs tf-conversions trajectory-msgs visualization-msgs"
