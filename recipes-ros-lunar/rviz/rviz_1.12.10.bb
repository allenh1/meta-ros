...
DEPENDS = "assimp assimp-dev python-empy-native cmake-modules eigen geometry-msgs image-transport interactive-markers laser-geometry libogre-dev libqt5-core libqt5-gui libqt5-opengl libqt5-opengl-dev libqt5-widgets liburdfdom-headers-dev map-msgs media-export message-filters nav-msgs opengl pluginlib python-qt-binding qtbase5-dev resource-retriever rosbag rosconsole roscpp roslib rospy sensor-msgs std-msgs std-srvs tf libtinyxml urdf visualization-msgs yaml-cpp"
