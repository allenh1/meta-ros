...
DEPENDS = "camera-calibration-parsers python-empy-native cv-bridge eigen geometry-msgs image-geometry image-transport message-filters nav-msgs nodelet pkgconfig roscpp rospy std-msgs swri-geometry-util swri-math-util swri-opencv-util tf"
