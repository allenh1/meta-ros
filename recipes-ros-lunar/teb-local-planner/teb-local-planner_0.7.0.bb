...
DEPENDS = "base-local-planner catkin cmake-modules costmap-2d costmap-converter dynamic-reconfigure geometry-msgs interactive-markers libg2o message-generation message-runtime nav-core nav-msgs pluginlib roscpp std-msgs tf tf-conversions visualization-msgs"
