...
DEPENDS = "angles python-empy-native geometry-msgs graphviz message-filters message-generation message-runtime rosconsole roscpp rostime roswtf sensor-msgs std-msgs tf2-ros"
...
S = "${WORKDIR}/geometry-release-release-lunar-tf-1.11.9-0"
