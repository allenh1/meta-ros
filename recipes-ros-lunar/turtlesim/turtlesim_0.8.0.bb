...
DEPENDS = "python-empy-native geometry-msgs libqt5-core libqt5-gui message-generation message-runtime qt5-qmake qtbase5-dev rosconsole roscpp roscpp-serialization roslib rostime std-msgs std-srvs"
