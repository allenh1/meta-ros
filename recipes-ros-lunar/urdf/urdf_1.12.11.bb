...
DEPENDS = "python-empy-native cmake-modules liburdfdom-dev liburdfdom-headers-dev pluginlib rosconsole-bridge roscpp rostest urdf-parser-plugin"
...
S = "${WORKDIR}/robot_model-release-release-lunar-urdf-1.12.11-0"
