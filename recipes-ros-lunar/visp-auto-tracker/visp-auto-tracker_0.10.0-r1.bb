...
DEPENDS = "python-empy-native geometry-msgs libdmtx-dev message-filters resource-retriever roscpp sensor-msgs std-msgs visp visp-bridge visp-tracker zbar"
