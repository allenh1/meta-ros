...
SRC_URI = "https://github.com/lagadic/visp-release/archive/release/lunar/visp/3.0.1-4.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/visp-release-release-lunar-visp-3.0.1-4"
